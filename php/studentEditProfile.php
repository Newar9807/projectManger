...
$sql = "SELECT * FROM `tbl_user` JOIN `tbl_program` ON `tbl_program`.`program_id` = `tbl_user`.`user_program_id` AND `tbl_user`.`user_id` = {$userID}";
...
<body>
    <div class="container">
        ...
        <?php if (!isset($_GET["id"])) include($root . "/php/assets/stdSidebar.php"); ?>
        <!-- Sidebar Ends -->
        <div class="main">
            <!-- Navigation Starts -->
            <div class="topbar"></div>
            <?php
            // include($root . "/php/assets/tecNav.php"); 
            ?>
            <!-- Navigation Ends -->
                        ...
                        <div class="profileInformation">
                            ...
                            <div class="row">
                                ...
                                <div class="col">
                                    ...
                                    <input type="text" name="program" id="program" data-id="<?= $res["user_program_id"]; ?>" value="<?= $res["program_name"]; ?>">
                                </div>
                            </div>
                        </div>
    ...
    <script>
        $(document).ready(function() {
            ...
            $('#editProfile').submit(function(e) {
                ...
                if (success == 6 && (newPassword == confirmPassword) && newPassword != "") {
                    ...
                    data.append("programId", $('#program').data('id'));
                    ...
                    $.ajax({
                        url: 'tempFunction/changeStdProfile.php', // <-- point to server-side PHP script 
                    ...
                    // $.post("tempFunction/changeStdProfile.php", {data}, function(response) {
