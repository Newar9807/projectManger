...
class programFunctions
{
    ...
    // SignIn
    public function signinMainMethod($conn)
    {
    ...
    public function studentMeetingMainMethod($conn)
    {
    ...
    // Teacher Functions
    public function changeStdProfileMainMethod($conn)
    {
        extract($_POST);
        ...
        if ($identifier == "changePassword") :
            ...
            if (mysqli_num_rows(mysqli_query($conn, $sql)) != 0) :
                ...
                $var = count($_FILES);
                if (count($_FILES) != 0) :
                    $dir =  $_SERVER["DOCUMENT_ROOT"] . 'finalProject/php/images/' . $_FILES["image"]["name"][0];
    ...
    public function changeTecProfileMainMethod($conn)
    {
    ...
    public function fetchProjectsMainMethod($conn)
    {
    ...
    public function fetchTaskDetailsTecMainMethod($conn)
    {
    ...
    public function fetchTaskPointsMainMethod($conn)
    {
    ...
    public function fetchMyTasksStatusMainMethod($conn)
    {
    ...
    // Filter
    public function filterTasksMainMethod($conn)
    {
    ...
    // Manage marks
    public function manageMarksMainMethod($conn)
    {
