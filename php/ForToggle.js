...
const planningPhaseHeader = document.querySelector('.phase-header.notification');
...
const analysisPhaseHeader = document.querySelectorAll('.phase-header.notification')[1];
...
const designPhaseHeader = document.querySelectorAll('.phase-header.notification')[2];
...
const developmentPhaseHeader = document.querySelectorAll('.phase-header.notification')[3];
...
const testingPhaseHeader = document.querySelectorAll('.phase-header.notification')[4];
...
const integrationPhaseHeader = document.querySelectorAll('.phase-header.notification')[5];
...
const maintainancePhaseHeader = document.querySelectorAll('.phase-header.notification')[6];
