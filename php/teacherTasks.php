...
<body>
    ...
    <script>
        $(document).ready(function() {
            ...
            const now = new Date();
            const year = now.getFullYear(); // Get the last two digits of the year
            const month = (now.getMonth() + 1).toString().padStart(2, '0'); // Add leading zero if necessary
            const day = (now.getDate() + 1).toString().padStart(2, '0'); // Add leading zero if necessary
